...
velux <- veluxdat[complete.cases(veluxdat[, !names(veluxdat) %in% c("religion_4")]),]
...
![**"Missing not at random" in action**. If you run a survey study, you'll rarely hear from people who don't want to participate in survey studies.](sampling_bias_meme.png){#id .class width=40% height=40%}
